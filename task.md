...
- [x] T063 [BR-007] Revamp Captain's Tabletop Environment & Under-Drawer (`Game.jsx`, `CrewSeatingDrawer.jsx`): Triển khai kiến trúc phân tầng bàn chỉ huy Eldritch Parchment: nền không gian khoang buồng thuyền (`cabin_room_bg.jpg`); container bàn làm việc Thuyền trưởng (`tabletop_captain_desk.png`, thu nhỏ ~80-85% viewport, góc nhìn 90° phẳng Flat Lay, mép đáy bàn phẳng không dính mặt đứng ngăn kéo); Central Stage trung tâm (70-80% diện tích bàn) luân chuyển tại chỗ giữa Hải đồ `MapBoardUI.jsx` và Action Desk Overlay; điểm kích hoạt tác chiến trên bàn; hộc ngăn kéo gầm bàn độc lập (`drawer_empty_shell.png`, non-sticky dưới mép bàn) chứa Tab Seating Radar và Tab Crew Roster; 100% Tiếng Anh `en-US`, nghiêm cấm emoji Unicode.
- [ ] T064 [BR-007] Revamp Crew Appointment Phase (`CrewAppointment.jsx` / `MutinyBoard.jsx`): Giao diện Thuyền trưởng chỉ định Phó thuyền trưởng (Lieutenant) và Hoa tiêu (Navigator) phong cách Eldritch Parchment: thẻ thủy thủ trực quan (avatar, số lượng súng, trạng thái Off-duty), huy hiệu bổ nhiệm rõ ràng, nút xác nhận đội ngũ điều hướng.
- [ ] T065 [BR-007] Revamp `MutinyBoard.jsx`: Giao diện bỏ phiếu Nổi loạn: cơ chế chọn và khóa súng cược bảo mật, hiệu ứng rung màn hình kịch tính khi công bố, bảng xếp hạng kết quả súng minh bạch và vinh danh Thuyền trưởng mới.
- [ ] T066 [BR-007] Revamp `NavigationPhase.jsx`: Giao diện điều hướng lái tàu: hiển thị 3 thẻ bài với nhận diện màu sắc đặc trưng 3 phe (Sailor, Pirate, Cult), thao tác chọn giữ/loại bỏ trực quan, bảo toàn logic rút bài.
- [ ] T067 [BR-007] Revamp `MapBoardUI.jsx`: Giao diện hải đồ hàng hải: nền giấy da dê phong hóa, 3 vùng cập bến nhận diện rõ ràng theo 3 phe, tàu buồm di chuyển theo lộ trình, ô sự kiện có biểu tượng và popover giải thích rõ nét.
- [ ] T068 [BR-007] Revamp `EndGame.jsx`: Giao diện kết thúc ván đấu: banner vinh danh chiến thắng theo phe thắng cuộc, hiệu ứng lật mở đồng loạt vai trò thật sự của toàn bộ người chơi trên bàn, phím điều hướng rõ ràng.
